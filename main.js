...
const menuTips = {
    ...
    en: {
        'Kimchi Stew': 'Adding extra tofu provides a great protein boost.',
        'Doenjang Stew': 'Fresh seasonal vegetables add vital vitamins.',
        'Bibimbap': 'Lots of mixed greens increase your fiber intake.',
        'Bulgogi': 'Wrapping it in lettuce keeps you full longer.',
        'Jeyuk Bokkeum': 'Stir-frying with garlic enhances the deep flavor.',
        'Fried Chicken': 'A fresh side salad is a perfect balance.',
        'Pizza': 'Try it with a light garden salad on the side.',
        'Hamburger': 'Chewing slowly helps with better digestion.',
        'Sushi': 'Goes perfectly with warm miso soup.',
        'Ramen': 'Adding bean sprouts adds a lovely crunch.',
        'Jajangmyeon': 'Onions with black bean paste are surprisingly healthy.',
        'Jjamppong': 'Rich seafood makes it a high-protein choice.',
        'Tangsu-yuk': 'Extra veggies in the sauce add extra vitamins.',
        'Malatang': 'Bok choy and mushrooms make it nutritionally balanced.',
        'Pho': 'A squeeze of lime helps with Vitamin C absorption.',
        'Donkatsu': 'Serve with plenty of shredded cabbage salad.',
        'Steak': 'Grilled asparagus is a perfect healthy side.',
        'Pasta': 'Whole wheat pasta is better for blood sugar control.',
        'Tteokbokki': 'A boiled egg is a great way to add protein.',
        'Samgyeopsal': 'Eating with perilla leaves provides essential minerals.'
    }
};
